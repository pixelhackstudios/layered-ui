...
|---|---|---|
| **Component Inventory** | 14 published items (`foundation`, `button`, `panel`, `input`, `select`, `display-card`, `textarea`, `checkbox`, `switch`, `dialog`, `tooltip`, `tabs`, `accordion`, `toast`) | Planned directions: `LayeredCombobox`, `LayeredPopover`/`LayeredDropdownMenu` |
